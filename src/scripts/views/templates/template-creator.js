...
const createTemplateResto = (create) => `
    <div class="card">
        <img class="lazyload card-img" height="200px" width="100%" src="${CONFIG.BASE_IMAGE_URL}small/${create.pictureId}" alt="${create.name}" title="${create.name}">
        <div class="card-city">${create.city}</div>
        <div class="card-content">
            <h3 class="card-title"><a tabindex="0" href="${`/#/detail/${create.id}`}">${create.name}</a></h3>
            <p class="card-rating">
                Rating : <span class="fa fa-star rating-value"> </span>
...
const createTemplateDetailResto = (create) => `
    <h2 tabindex="0" class="explore">Detail of ${create.name}</h2>
    <div class="restaurant-profile">
        <div class="restaurant-img-container">
            <img class="restaurant-img-detail" height="400px" width="100%" src="${CONFIG.BASE_IMAGE_URL}large/${create.pictureId}" alt="Restaurant ${create.name}">
        </div>
    ...
    <div class="restaurant-detail">
        ...
        <h2>Our Reviews (${create.customerReviews.length})</h2>
...
const createNoFavoriteTemplate = () => `
    <div class="empty-container">
        <p class="empty-text">You haven't add a favorite restaurant yet...</p>
...
const createSkeletonTemplate = (count) => {
    ...
    for (let i = 0; i < count; i += 1) {
        template += `
        <div class="card">
            <img class="card-img" height="200px" width="100%" alt="skeleton">
            <div class="card-content">
